...
VL_ATTR_COLD void Vsha256_processor_tb___024root__trace_init_sub__TOP__0(Vsha256_processor_tb___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->declBit(c+99,0,"ext_clk",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+100,0,"test_complete",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+101,0,"test_passed",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+102,0,"FILE_SIZE",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declArray(c+103,0,"EXPECTED_HASH",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 255,0);
    ...
    tracep->declBus(c+102,0,"BLOCK_SIZE",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+111,0,"IDLE",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+112,0,"LOAD",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+113,0,"PAD",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+114,0,"HASH",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+115,0,"DONE",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declQuad(c+71,0,"total_bits",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 63,0);
    tracep->declBit(c+73,0,"seen_last",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+74,0,"need_length_block",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+75,0,"pad_index",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 5,0);
    ...
    tracep->declBus(c+116,0,"H0_INIT",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+117,0,"H1_INIT",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+118,0,"H2_INIT",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+119,0,"H3_INIT",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+120,0,"H4_INIT",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+121,0,"H5_INIT",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+122,0,"H6_INIT",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+123,0,"H7_INIT",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+79,0,"c",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+80,0,"d",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+81,0,"e",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+82,0,"f",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+83,0,"g",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+84,0,"h",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+85,0,"h0",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+86,0,"h1",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+87,0,"h2",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+88,0,"h3",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+89,0,"h4",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+90,0,"h5",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+91,0,"h6",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+92,0,"h7",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+93,0,"t",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 6,0);
    tracep->declBus(c+94,0,"msg_idx",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 6,0);
    ...
    tracep->declBus(c+124,0,"IDLE",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 1,0);
    tracep->declBus(c+125,0,"PREP",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 1,0);
    tracep->declBus(c+126,0,"COMP",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 1,0);
    tracep->declBus(c+127,0,"DONE",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 1,0);
    tracep->declBus(c+96,0,"T1",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+97,0,"T2",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+98,0,"i",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::INTEGER, false,-1, 31,0);
    tracep->popPrefix();
    tracep->popPrefix();
    tracep->popPrefix();
}
...
VL_ATTR_COLD void Vsha256_processor_tb___024root__trace_const_0_sub_0(Vsha256_processor_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullIData(oldp+102,(0x40U),32);
    bufp->fullWData(oldp+103,(Vsha256_processor_tb__ConstPool__CONST_h7044a45f_0),256);
    ...
    bufp->fullIData(oldp+116,(0x6a09e667U),32);
    bufp->fullIData(oldp+117,(0xbb67ae85U),32);
    bufp->fullIData(oldp+118,(0x3c6ef372U),32);
    bufp->fullIData(oldp+119,(0xa54ff53aU),32);
    bufp->fullIData(oldp+120,(0x510e527fU),32);
    bufp->fullIData(oldp+121,(0x9b05688cU),32);
    bufp->fullIData(oldp+122,(0x1f83d9abU),32);
    bufp->fullIData(oldp+123,(0x5be0cd19U),32);
    bufp->fullCData(oldp+124,(0U),2);
    bufp->fullCData(oldp+125,(1U),2);
    bufp->fullCData(oldp+126,(2U),2);
    bufp->fullCData(oldp+127,(3U),2);
}
...
VL_ATTR_COLD void Vsha256_processor_tb___024root__trace_full_0_sub_0(Vsha256_processor_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullQData(oldp+71,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__total_bits),64);
    bufp->fullBit(oldp+73,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__seen_last));
    bufp->fullBit(oldp+74,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__need_length_block));
    bufp->fullCData(oldp+75,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__pad_index),6);
    bufp->fullIData(oldp+76,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__i),32);
    bufp->fullIData(oldp+77,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__a),32);
    bufp->fullIData(oldp+78,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__b),32);
    bufp->fullIData(oldp+79,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__c),32);
    bufp->fullIData(oldp+80,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__d),32);
    bufp->fullIData(oldp+81,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__e),32);
    bufp->fullIData(oldp+82,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__f),32);
    bufp->fullIData(oldp+83,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__g),32);
    bufp->fullIData(oldp+84,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__h),32);
    bufp->fullIData(oldp+85,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__h0),32);
    bufp->fullIData(oldp+86,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__h1),32);
    bufp->fullIData(oldp+87,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__h2),32);
    bufp->fullIData(oldp+88,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__h3),32);
    bufp->fullIData(oldp+89,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__h4),32);
    bufp->fullIData(oldp+90,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__h5),32);
    bufp->fullIData(oldp+91,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__h6),32);
    bufp->fullIData(oldp+92,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__h7),32);
    bufp->fullCData(oldp+93,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__t),7);
    bufp->fullCData(oldp+94,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__msg_idx),7);
    bufp->fullCData(oldp+95,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__state),2);
    bufp->fullIData(oldp+96,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__T1),32);
    bufp->fullIData(oldp+97,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__T2),32);
    bufp->fullIData(oldp+98,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__i),32);
    bufp->fullBit(oldp+99,(vlSelfRef.ext_clk));
    bufp->fullBit(oldp+100,(vlSelfRef.test_complete));
    bufp->fullBit(oldp+101,(vlSelfRef.test_passed));
}

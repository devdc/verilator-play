...
void Vsha256_processor_tb___024root__trace_chg_0_sub_0(Vsha256_processor_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelfRef.__Vm_traceActivity[3U])) {
        ...
        bufp->chgBit(oldp+70,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__core_ready_prev));
        bufp->chgQData(oldp+71,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__total_bits),64);
        bufp->chgBit(oldp+73,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__seen_last));
        bufp->chgBit(oldp+74,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__need_length_block));
        bufp->chgCData(oldp+75,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__pad_index),6);
        bufp->chgIData(oldp+76,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__i),32);
        bufp->chgIData(oldp+77,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__a),32);
        bufp->chgIData(oldp+78,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__b),32);
        bufp->chgIData(oldp+79,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__c),32);
        bufp->chgIData(oldp+80,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__d),32);
        bufp->chgIData(oldp+81,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__e),32);
        bufp->chgIData(oldp+82,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__f),32);
        bufp->chgIData(oldp+83,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__g),32);
        bufp->chgIData(oldp+84,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__h),32);
        bufp->chgIData(oldp+85,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__h0),32);
        bufp->chgIData(oldp+86,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__h1),32);
        bufp->chgIData(oldp+87,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__h2),32);
        bufp->chgIData(oldp+88,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__h3),32);
        bufp->chgIData(oldp+89,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__h4),32);
        bufp->chgIData(oldp+90,(vlSelfRef.sha256_processor_tb__DOT__uut__DOT__sha_core__DOT__h5),32);
